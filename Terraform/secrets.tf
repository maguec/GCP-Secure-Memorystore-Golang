...
#  secret_data = google_memorystore_instance.cache.auth_string
#}
#
...
#  secret_data = google_memorystore_instance.cache.host
#}
#
...
#  secret_data = google_memorystore_instance.cache.port
#}
